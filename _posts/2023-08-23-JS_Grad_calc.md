...
description: A Java Script Grade Calculator
type: hacks
...
In this Hack we imbeded JavaScript using Script Tags in the html. using the process of JavaScript User Inputs, For Loops, JS Conditonal Statements, and If Else Statments. A Grade Calculator was able to be developed.
